...
3. SERVQUAL의 서비스 갭(Gap) 모델  
    ...
    * **Gap 1 (경영진 인식 갭)**: 고객의 기대치와 경영진이 파악한 고객 기대치 간의 차이
    * **Gap 2 (품질 규격 갭)**: 경영진의 인식과 실제 설정된 서비스 품질 명세(표준) 간의 차이
    * **Gap 3 (서비스 전달 갭)**: 설정된 품질 명세와 실제 현장 직원이 전달한 서비스 수준 간의 차이
    * **Gap 4 (커뮤니케이션 갭)**: 실제 제공된 서비스와 외부 광고·마케팅으로 약속한 내용 간의 차이
    * **Gap 5 (최종 서비스 갭)**: 고객이 기대한 서비스(E)와 실제 느낀 서비스(P) 간의 차이 **(Gap 1~4가 축적되어 발생)**
