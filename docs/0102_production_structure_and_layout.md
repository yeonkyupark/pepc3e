...
- ==수직통합형 생산구조==(Integrated Structure)  
    - ==원자재 가공부터 최종 조립== 까지 한 ==기업이 대규모 자산을 소유== 하며 통제하는 구조다.
    - 소품종 대량 생산이나 철강, 석유화학 등 장치 산업(연속 공정)에서 주로 나타난다.
- 네트워크형 / 모듈러 <mark>생산</mark>구조(Networked / Modular Structure)  
    - 핵심 설계와 <mark>브랜드만 보유</mark>하고, <mark>부품 생산과 조립</mark>은 전 세계 협력사 네트워크에 분산시키는 구조다.
...
1. 유동 및 활동관계 분석(Flow & Activity Releationship)
