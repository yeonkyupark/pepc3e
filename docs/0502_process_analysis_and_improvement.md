...
**가치흐름지도(VSM, Value Stream Mapping)**는 자재의 입고부터 최종 제품이 고객에게 전달되기까지의 <span class='hl'>전체 공정에서 물류와 정보의 흐름을 시각적으로 도식화하여 낭비 요소를 식별하고 공정을 개선하는 린(Lean) 생산방식의 핵심 프로세스 분석 도구</span>이다.
