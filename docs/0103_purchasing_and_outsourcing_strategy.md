현재 구성은 전반적으로 적절하지만, 기술사 관점에서는 다음과 같은 개선이 필요하다.

### 현재 구성의 문제점

* 구매(Purchasing)와 조달(Procurement)의 전략적 차이가 충분히 드러나지 않음
* 구매관리 → 구매가격 → 할인방식 순서는 자연스럽지만, 현대 SCM 관점의 공급자 관리(SRM)가 빠져 있음
* 자가생산/외주생산, 수직적 통합, 오프쇼어링이 각각 독립적으로 보임
* Make or Buy 의사결정 체계가 없음
* 최근 출제경향인 공급망 리스크, Reshoring, 공급망 회복탄력성(Resilience)이 반영되지 않음
* 아웃소싱이 외주전략의 하위 개념으로만 설명되어 전략적 의미가 부족함

기술사 답안 관점에서는 아래와 같은 흐름이 가장 자연스럽다.
...
구매와 외주전략은 기업이 필요한 자원과 역량을 내부에서 확보할 것인지 외부에서 조달할 것인지를 결정하는 전략적 의사결정이다. 최근에는 단순한 원가절감 관점을 넘어 공급망 안정성, 핵심역량 강화, 공급망 회복탄력성(Resilience) 확보가 중요한 전략적 과제로 부각되고 있다.
...
구매관리는 적정한 자재를 적정한 시점에 적정한 가격으로 확보하여 생산활동을 지원하는 것을 목적으로 한다.
