...
1. **공정선택**(Process Selection)  
    공정선택은 제품 특성과 생산량에 적합한 생산방식을 선택하는 과정이다. Hayes & Wheelwright가 제시한 [제품-공정 행렬(Product-Process Matrix)](https://yeonkyupark.github.io/pepc3e/0101_competitive_manufacturing_strategy/#product-process-matrix)가 대표적인 이론이다.
